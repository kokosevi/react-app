...
function PollWindow() {
    ...
    const security = [];
        ...
        security[0].item = "If my partner wants to spend time with me all the time, it becomes „too tight“ for me";    security[0].posneg = -1; //"Wenn mein Partner ständig Zeit mit mir verbringen will, wird es mir „zu eng“."; 
        security[1].item = "Being with the same people all the time can be „too much“ for me as well";                  security[1].posneg = -1; //"Dauernd mit den selben Leuten zusammen zu sein kann mir auch „zu viel“ werden."; 
    ...
    const reliability = [];
        ...
        reliability[3].item = "I don't worry about the future.";                        reliability[3].posneg = -1;
        reliability[4].item = "I invest a lot of time to make my future predictable.";
        reliability[5].item = "The future is bright for me.";                           reliability[5].posneg = -1;
    ...
    pleasure[7].item = "Pleasure.";
        ...
        adventure[0].item = "I like to have a familiar daily routine";   adventure[0].posneg = -1;            //"Ich habe gerne einen gewohnten Tagesablauf.";
        adventure[1].item = "In a completely foreign environment I become insecure";    adventure[1].posneg = -1;    //"In einer völlig fremden Umgebung werde ich unsicher.";     
        adventure[2].item = "I get bored very quickly if I do not have a varied activity";                //"Ich langweile mich sehr schnell, wenn ich keine abwechslungsreiche Tätigkeit habe.";
        ...
        adventure[5].item = "I often need quiet times when I do not do anything"; adventure[5].posneg = -1;            //"Ich brauche oft ruhige Zeiten, in denen ich nichts unternehme.";
        adventure[6].item = "I would like to do something all the time";            //"Am liebsten möchte ich ständig etwas unternehmen.";
        adventure[7].item = "I prefer familiar situations to new ones"; adventure[7].posneg = -1;            //"Ich bevorzuge bekannte Situationen gegenüber neuen.";
        ...
        power[1].item = "I hate to assert myself against others";                  power[1].posneg = -1    //"Ich setze mich gerne gegen andere durch.";
        ...
        power[6].item = "In important decisions, I like to fit in with the group"; power[6].posneg = -1;    //"In wichtigen Entscheidungen, füge ich mich gerne in die Gruppe ein.";
    ...
    respect[1].item = "I don't care so much if the people around me think I'm great."; respect[1].posneg = -1;
    respect[2].item = "I couldn't care less what other people think about me.";         respect[2].posneg = -1;
